...
class Branch(nn.Module):
    ...
    This branch, refers to the case where the model accepts data having 7 features for each point of the input pointclouds.



    Architecture:
    - Input: a tensor ('batch_1' or 'batch_2') of point clouds having 7 features (x, y, z, nx, ny, nz, A) for each point
...
class PairModel1(nn.Module):
    ...
    Architecture:
    - Input: the two tensors 'batch_1' and 'batch_2' of point clouds having 7 features (x, y, z, nx, ny, nz, A) for each point.
